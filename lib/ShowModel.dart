import 'package:tv_show_app/ImageModel.dart';
import 'package:tv_show_app/RatingModel.dart';
...
class ShowModel{
  ...
  factory ShowModel.fromJson(Map<String, dynamic> json){
    return ShowModel(
      ...
      rating: json['rating'] == null? RatingModel(avarage: 0):RatingModel.fromJson(json['rating']),
